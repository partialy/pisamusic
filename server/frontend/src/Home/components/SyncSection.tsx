...
export default function SyncSection() {
  return (
    <section id="sync" className="bg-[#101828] py-20 text-white sm:py-28">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:gap-12 lg:px-10">
        ...
        <div className="grid content-start gap-4">
          ...
          <div className="rise-in rounded-lg border border-sky-300/20 bg-sky-300/10 p-5">
